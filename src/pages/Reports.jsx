...
        )}
      </div>
      <style>{ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@keyframes slide-in-right { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from { transform: translateX(100%); opacity: 0; } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to { transform: translateX(0); opacity: 1; } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.animate-slide-in-right { animation: slide-in-right 0.3s ease-out; } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</style>
    </div>
  );
}
